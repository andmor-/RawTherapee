...
//        parent->ipf.ip_wavelet(labnCrop, labnCrop, kall, WaveParams, wavCLVCurve, wavblcurve, waOpacityCurveRG, waOpacityCurveBY, waOpacityCurveW, waOpacityCurveWL, parent->wavclCurve, skip);
        ...
        if (params.icm.workingTRC != ColorManagementParams::WorkingTrc::NONE) {
            ...
            int ill = 0;
            parent->ipf.workingtrc(skip, tmpImage1.get(), tmpImage1.get(), GW, GH, -5, prof, 2.4, 12.92310, ill, 0, cmsDummy, true, false, false);
            parent->ipf.workingtrc(skip, tmpImage1.get(), tmpImage1.get(), GW, GH, 5, prof, gamtone, slotone, illum, prim, cmsDummy, false, true, true);
            ...
            if (rad > 0.f) {
                ...
                int r = rtengine::max(int(gu / skip), 1);
