...
*/
            ...
            if (params->icm.workingTRC != ColorManagementParams::WorkingTrc::NONE) {
                ...
                int ill = 0;
                ipf.workingtrc(scale, tmpImage1.get(), tmpImage1.get(), GW, GH, -5, prof, 2.4, 12.92310, ill, 0, dummy, true, false, false);
                ipf.workingtrc(scale, tmpImage1.get(), tmpImage1.get(), GW, GH, 5, prof, gamtone, slotone, illum, prim, dummy, false, true, true);
                ...
                if (rad > 0.f) {
                    ...
                    int r = rtengine::max(int(gu / scale), 1);
