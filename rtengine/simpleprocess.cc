...
*/
        ...
        if (params.icm.workingTRC != ColorManagementParams::WorkingTrc::NONE) {
            ...
            int ill = 0;
            ipf.workingtrc(1, tmpImage1.get(), tmpImage1.get(), GW, GH, -5, prof, 2.4, 12.92310, ill, 0, dummy, true, false, false);
            ipf.workingtrc(1, tmpImage1.get(), tmpImage1.get(), GW, GH, 5, prof, gamtone, slotone, illum, prim, dummy, false, true, true);
